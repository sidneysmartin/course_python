...
50 - R$ 9.00
"""
total_product = int(input("Total de produtos vendidos: "))
value_product = float(input("Preço do pão: "))
amount = 0
for i in range(1, total_product + 1):
    print(f"{i} - R$ {i * value_product:.2f}")


print(f"Total de vendas: {total_product * value_product:.2f}")
